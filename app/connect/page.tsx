        ...
        <div className="container-wide py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/80 md:text-xl">
              Subang Philippines welcomes young people, volunteers, communities,
              schools, local governments, organizations, and institutions who
              want to contribute to meaningful community action.
            </p>

            <p className="mt-5 max-w-2xl text-base leading-7 text-white/70">
              Whether you want to volunteer, explore a partnership, invite
              Subang Philippines to an activity, or simply learn more about our
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            ...
            <div className="border border-black/10 bg-sand p-8">
              ...
              <p className="mt-4 leading-7 text-ink/70">
                ...
                youth activity where our team can contribute? Get in touch with
                us and tell us how we can collaborate.
              </p>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-1 font-bold text-maroon break-all">
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-ink/60">
                    For membership applications, inquiries, and expressions of
                    interest in becoming part of Subang Philippines.
                  </p>
                </div>
        ...
        <div className="container-wide">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl leading-7 text-ink/70">
              Follow our social media channels for community stories, volunteer
              opportunities, program updates, and announcements.
            </p>
          </div>
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                >
                  ...
                  <option value="invite">Invite Subang Philippines</option>
      ...
      <section className="bg-white section-pad">
        <div className="container-wide text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-ink/65">
            Every contribution matters. Every community has a story. And every
            young person has the capacity to create change.
          </p>
