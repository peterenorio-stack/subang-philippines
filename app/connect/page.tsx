      ...
      <main className="bg-white">
        ...
        <section className="bg-white py-16 md:py-20">
          <div className="container-wide text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg leading-7 text-ink/65">
            ...
            <Link
              href="/about"
              className="mt-7 inline-flex items-center gap-2 border border-maroon px-6 py-3 font-bold text-maroon transition hover:bg-maroon hover:text-white"
            >
